...
- [ ] Crear `lib/reports/postventaVsMl.tsx`.
- [ ] Crear endpoint `app/api/reports/postventa/route.ts`.
- [ ] Reutilizar estilos PDF existentes donde aplique.
- [ ] Agregar acción de descarga en UI.
- [ ] Agregar tests o verificación manual del PDF.
...
- [ ] Descargar PDF.
- [ ] Verificar productos con comparable.
- [ ] Verificar productos sin comparable.
